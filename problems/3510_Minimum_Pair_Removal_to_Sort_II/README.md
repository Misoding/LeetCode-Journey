# Day 7: Minimum Pair Removal to Sort Array II

- **Difficulty:** HARD
- **Topics:** Heap (Priority Queue), Linked List Simulation, Greedy, Lazy Deletion
- **LeetCode Link:** [Minimum Pair Removal to Sort Array II](https://leetcode.com/problems/minimum-pair-removal-to-sort-array-ii/)
